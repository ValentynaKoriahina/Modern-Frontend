...
// //     case REQUEST_ADD_EXERCISE: // CHANGES!!
// //       return {
// //         ...state,
// //         isLoading: true,
// //         error: null,
...
import {
  ...
  ERROR_ADD_EXERCISE,
  EDIT_EXERCISE,
  REQUEST_EDIT_EXERCISE, // CHANGES!!
  ERROR_EDIT_EXERCISE, // CHANGES!!
  DELETE_EXERCISE,
  REQUEST_DELETE_EXERCISE,
  ERROR_DELETE_EXERCISE,
} from '../constants/actionTypes';
...
const exercisesReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case REQUEST_DELETE_EXERCISE:
    case REQUEST_ADD_EXERCISE:
    case REQUEST_EDIT_EXERCISE: // CHANGES!!
      return {
        ...state,
        isLoading: true,
        error: null,
    ...
    case ERROR_DELETE_EXERCISE:
    case ERROR_ADD_EXERCISE:
    case ERROR_EDIT_EXERCISE: // CHANGES!!
      return {
        ...state,
        isLoading: false,
        error: action.payload,
